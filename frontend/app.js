    ...
    medicines.forEach((med, i) => {
        ...
        card.innerHTML = `
            <div class="medicine-card-header">
                ...
                <button class="btn btn-outline btn-small" onclick="openReminderModal('${esc(med.name || 'Unknown Medicine').replace(/'/g, "\\'")}')" style="margin: 0 0 0 auto; padding: 6px 10px; font-size: 0.75rem;">🔔 Set</button>
            </div>
